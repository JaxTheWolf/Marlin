 ...
 */
  ...
  #define MPC_SENSOR_RESPONSIVENESS { 0.1046f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 1.3333f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1558f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp  36.75
  #define DEFAULT_bedKi   2.08
  #define DEFAULT_bedKd 433.11
