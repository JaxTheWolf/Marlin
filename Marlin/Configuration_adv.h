...
//#define INPUT_SHAPING_Z
    ...
    #define SHAPING_FREQ_X  25.606f     // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.15       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  25.606f     // (Hz) The default dominant resonant frequency on the Y axis.
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD
    ...
    #define X_AXIS_TWIST_COMPENSATION
      ...
      #define XATC_MAX_POINTS 7            // Number of points to probe in the wizard
      #define XATC_Y_POSITION Y_CENTER      // (mm) Y position to probe
      #define XATC_Z_OFFSETS { 0, 0, 0, 0, 0, 0, 0 }    // Z offsets for X axis sample points
    #endif
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define SENSORLESS_STALLGUARD_DELAY   50 // (ms) Delay to allow drivers to settle
